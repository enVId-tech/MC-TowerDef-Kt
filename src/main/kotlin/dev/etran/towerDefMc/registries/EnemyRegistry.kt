...
object EnemyRegistry {
    ...
    private fun createDefaultEnemiesConfig(file: File) {
        ...
        config.set("enemies.Basic_Enemy_1.description", listOf(
            "Standard enemy",
            "Medium speed",
            "Low health"
        ))
        ...
        config.set("enemies.Fast_Enemy.description", listOf(
            "Fast enemy",
            "High speed",
            "Low health"
        ))
        ...
        config.set("enemies.Tank_Enemy.description", listOf(
            "Slow enemy",
            "Low speed",
            "High health"
        ))
        ...
        config.set("enemies.Boss_Enemy.description", listOf(
            "Boss enemy",
            "Medium speed",
            "Very high health"
        ))
