    ...
    override fun setMenuItems() {
        inventory.setItem(
            10, createRenamableItem(
                Material.REDSTONE_BLOCK, "Max Health: {VALUE}", listOf("The default maximum game health."), "100"
            )
        )
        ...
        inventory.setItem(
            16, createRenamableItem(
                Material.OAK_SIGN, "Game Name: {VALUE}", listOf("Your saved game name"), "Game"
            )
        )

        inventory.setItem(
            34, createMenuItem(
                Material.REDSTONE_BLOCK, "Cancel", listOf(
                    "Cancels the current configuration", "WARNING: The current configuration will be LOST!"
                )
            )
        )
        ...
        inventory.setItem(
            35, createMenuItem(
                Material.EMERALD_BLOCK, "Save", listOf(
                    "Saves the current configuration", "NOTE: You can adjust waves in the Modify Game menu."
                )
            )
        )
    }
